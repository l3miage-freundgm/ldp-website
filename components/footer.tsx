        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/sobre-mi" className="text-gray-600 hover:text-rose-600 transition-colors">
                  Sobre Mí
                </Link>
              </li>
              <li>
                <Link href="/servicios" className="text-gray-600 hover:text-rose-600 transition-colors">
                  Servicios
                </Link>
              </li>
              <li>
                <Link href="/podcast" className="text-gray-600 hover:text-rose-600 transition-colors">
                  Podcast
                </Link>
              </li>
              <li>
                <Link href="/youtube" className="text-gray-600 hover:text-rose-600 transition-colors">
                  YouTube
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contacto" className="text-gray-600 hover:text-rose-600 transition-colors">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <Phone className="h-5 w-5 text-rose-600 mr-2 shrink-0" />
                <span className="text-gray-600">+506 8888-8888</span>
              </li>
              <li className="flex items-start">
                <Mail className="h-5 w-5 text-rose-600 mr-2 shrink-0" />
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link href="/privacidad" className="text-gray-500 hover:text-rose-600 text-sm transition-colors">
                Política de Privacidad
              </Link>
              <Link href="/terminos" className="text-gray-500 hover:text-rose-600 text-sm transition-colors">
