  ...
  return (
    ...
    >
      <Link
        ...
        target="_blank"
        className="flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md text-rose-600 hover:bg-rose-600 hover:text-white transition-colors"
