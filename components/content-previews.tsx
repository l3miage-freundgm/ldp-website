    ...
    <div className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-rose-700 mb-4">Contenido Destacado</h2>
            ...
            <Card className="bg-white shadow-md">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 p-6">
                  <h3 className="text-2xl font-semibold text-rose-700 mb-2">Podcast "Mente Plena"</h3>
          ...
          <TabsContent value="youtube">
            <Card className="bg-white shadow-md">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1 p-6">
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Button className="rounded-full w-12 h-12 bg-rose-600 hover:bg-rose-700">
                ...
                <div className="md:col-span-2 p-6">
                  <h3 className="text-2xl font-semibold text-rose-700 mb-2">Canal de YouTube</h3>
                  <p className="text-gray-700 mb-4">
          ...
          <TabsContent value="blog">
            <Card className="bg-white shadow-md">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 p-6">
                  <h3 className="text-2xl font-semibold text-rose-700 mb-2">Blog</h3>
                  <p className="text-gray-700 mb-4">
