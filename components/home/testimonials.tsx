    ...
    <div className="py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-sage-700 mb-4">Lo Que Dicen Mis Clientes</h2>
        ...
        <div className="max-w-4xl mx-auto relative">
          <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              <Quote className="h-12 w-12 text-sage-200 mb-6" />
          ...
          <div className="flex justify-center mt-6 space-x-2">
            {testimonials.map((_, index) => (
              <button
                key={index}
                className={`w-3 h-3 rounded-full ${index === currentIndex ? "bg-sage-600" : "bg-gray-300"}`}
                onClick={() => {
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 text-sage-600 hover:bg-sage-50 hidden md:flex"
            onClick={() => {
              prevTestimonial()
              setAutoplay(false)
            }}
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 text-sage-600 hover:bg-sage-50 hidden md:flex"
            onClick={() => {
              nextTestimonial()
              setAutoplay(false)
            }}
