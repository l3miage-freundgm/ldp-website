    ...
    <div className="py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-sage-700 mb-4">Mis Servicios</h2>
            ...
            <Card key={index} className="bg-white shadow-md hover:shadow-lg transition-shadow h-full flex flex-col">
              ...
              <CardFooter className="mt-auto">
                <Button
                  asChild
                  variant="ghost"
                  className="w-full justify-start text-sage-600 hover:text-sage-700 hover:bg-sage-50 p-0"
                >
